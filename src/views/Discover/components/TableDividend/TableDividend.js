            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">PaymentDate</TableCell>
                  <TableCell align="right">ExDividenDate</TableCell>
                  <TableCell align="right">Declaration</TableCell>
              ...
              <TableBody>
                {list.map((item) => (
                  ...
                  >
                    ...
                    <TableCell style={stylesLocal.cell} align="right">{'$ '}{item.dividend_amount}</TableCell>
